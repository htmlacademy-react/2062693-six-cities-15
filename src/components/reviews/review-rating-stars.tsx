  ...
  return (
    <div className="reviews__rating-form form__rating">
      {rating.map((item, id) => {
        ...
        return (
        <Fragment key={id}>
          <input className="form__rating-input visually-hidden" name="rating" value={ratingId} id={`${ratingId}-stars`}
                 type="radio" checked={checkedStar===ratingId} onChange={clickStarHandler}/>
