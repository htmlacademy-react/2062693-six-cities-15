...
export default function ReviewForm() {
  ...
  return (
    <form className="reviews__form form" method="post" onSubmit={submitForm}>
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" value={inputFields.message} onChange={onChangeMessageValue}></textarea>
